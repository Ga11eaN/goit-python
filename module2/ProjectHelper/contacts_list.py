...
class ContactList(UserDict, BasePrint):
    ...
    def find(self, find_value):
        ...
        for key, value in self.data.items():
            ...
            search_values = (
                value["address"] + value["phone"] + value["mail"] + [value["birthday"]]
            )
        ...
        if not finded_names:
            ...
            print(" {:_^105}".format(""))
            print(
                "|{:<10}|{:^27}|{:^27}|{:^27}|{:>10}|".format(
                    "name", "phone", "address", "mail", "birthday"
                )
            )
            print(" {:‾^105}".format(""))
    ...
    def change_name(self):
        while True:
            ...
            if user_input not in self.data.keys():
                user_input2 = input(
                    "Entered name is not in the contact book.\n1. Try again\n2.return to previous menu?\n"
                )
                if user_input2 == "1":
                    continue
                else:
    ...
    def birthdays(self, days_from, days_to):
        ...
        if (
            not (isinstance(days_from, int) and isinstance(days_to, int))
            or days_from < 0
            or days_to < 0
            or days_to < days_from
        ):
        ...
        for key, value in self.data.items():
            ...
            if date_from.month < value["birthday"].month:
                ...
                if date_from.day <= value["birthday"].day:
                    ...
                    birthday_date = value["birthday"].date.replace(
...
class Record(UserDict):
    ...
    def add_value(self, value):
        while True:
            ...
            user_input = input(
                f"Enter the {value} please (If you don't want to enter {value}, leave empty): "
            )
    ...
    def __phone_check(self, phone):
        ...
        if fullmatch(PHONE_CHECK, phone) or not phone:
            ...
            print(
                "Phone number is not correct. Should start from +380 or 380, have correct operator number and 12 digits"
            )
            return False
    ...
    def add_birthday(self):
        while True:
            ...
            user_input = input(
                'Enter the birthday please in format "DD.MM.YYYY"(If you do not want to enter birthday, leave empty): '
            )
    ...
    def change_value(self):
        ...
        while True:
            user_input = input(
                "What value do you want to change/delete?\n1. Phone\n2. Address\n3. Mail\n4. Birthday\n5. Back\n"
            )
            ...
            if user_input not in CORRECT_INPUT:
                ...
                user_input = input(
                    f'Choose the number of {value} to change/delete. If you want to delete all values, type "clear": '
                )
                ...
                data_input = input(
                    f"Enter the correct {value} or leave empty if you want to delete {value}: "
                )
